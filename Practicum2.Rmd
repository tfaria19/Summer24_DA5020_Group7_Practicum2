...
total_icu_sicu_census_beds <- "SELECT business_name AS hospital_name, SUM(census_beds) AS total_icu_sicu_census_beds
FROM combined_table
...
total_icu_sicu_census_beds <- dbGetQuery(p2_connection, total_icu_sicu_census_beds)

print(total_icu_sicu_census_beds)
```

```{r}
census_beds_combined_visual <- "
...
print(census_beds_combined_visual)
