...
The hospitals that have the most license ICU and SICU beds are Phoenix Childrens Hospital and University of Maryland Medical Center. Based on the finding for the census beds, it looks like Shands Hospital at University of Florida and Dallas County Hospital Association have the most census beds that include ICU and SICU beds. The hospitals that have the most staffed beds are Vidant Medical Center	and
Rady Childrens Hospital and Health Center. Some of these hospitals shows up on all three tables in the top 10 hospitals for each of the different beds. For example, Vidant Medical Center appears on all three tables and could be a good candidate for the intervention pilot program. 
...
ggplot(pivot_combined_staffed_beds_visual_df, aes(reorder(hospital_name, -bed_count), bed_count, fill = bed_type)) +
  ...
  y = "Staffed Bed Count",
  fill = "Bed",
  title = "Hospitals with Highest Combined Total ICU and SICU Census Beds",
  caption = "Minimum 1 ICU and SICU bed per hospital"
  ) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA)) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 15)) +
  theme_classic() +
