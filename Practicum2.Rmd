...
ggplot(pivot_license_beds_df, aes(reorder(hospital_name, -bed_count), bed_count, fill = bed_type)) +
  ...
  caption = "Figure 1C: ICU and SICU license beds combined with no minimum required count"
  ) +
...
ggplot(pivot_census_beds_df, aes(reorder(hospital_name, -bed_count), bed_count, fill = bed_type)) +
  ...
  caption = "Figure 2C: ICU and SICU census beds combined with no minimum required count"
  ) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, NA)) +
  theme_classic() +
  theme(
...
ggplot(pivot_staffed_beds_df, aes(reorder(hospital_name, -bed_count), bed_count, fill = bed_type)) +
  ...
  y = "Staffed Bed Count",
  fill = "Bed",
  title = "Hospitals with highest combined ICU or SICU staffed bed
  counts",
