...
staffed_beds_separate <- "SELECT business_name AS hospital_name,
...
total_staffed_beds <- dbGetQuery(p2_connection, staffed_beds_separate) %>%
  as_tibble()
total_staffed_beds
...
```{r}
ggplot(total_staffed_beds, aes(reorder(hospital_name, -total_icu_sicu_staffed_beds), total_icu_sicu_staffed_beds, fill = hospital_name)) +
